...
import { BellIcon, CheckIcon, MoonIcon, SunIcon } from "@radix-ui/react-icons";
...
import { CarouselSize } from "./projects";

export function ModeToggle() {
  const { setTheme } = useTheme();

  return (
    <DropdownMenu classname="flex items-end">
...
export default function Home({ className, ...props }: CardProps) {
  return (
    <div>
      <ModeToggle />
      <div className="h-[32rem] flex justify-center items-center flex-col">
      ...
      <div className="flex justify-center items-center flex-col m-[8rem]">
        <h2 className="text-4xl font-bold text-lightRed">Experience</h2>
        <WorkExperienceCard />
        <Separator />
      </div>
      <div className="mb-[4rem] flex justify-center items-center flex-col">
        <h2 className="h-[4.2rem] text-4xl font-bold text-lightRed">
          Projects
        </h2>
        <CarouselSize />
      </div>
